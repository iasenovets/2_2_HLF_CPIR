...
\paragraph{Channel Mini (LogN=13).}
...
\paragraph{Channel Rich (LogN=15).}
...
Each channel maintains its own plaintext polynomial database $m_{\mathrm{DB}}$ encoded according to Alg.~\ref{alg:ledger-init}. 
