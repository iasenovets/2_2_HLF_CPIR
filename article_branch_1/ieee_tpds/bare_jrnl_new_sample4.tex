...
China under Grant2021YFF0704102, in part by the Key Project of Science and Technology Research by Chongqing Education Commission under 
...
% The paper headers
\markboth{IEEE Transactions on Parallel and Distributed Systems,~Vol.~XX, No.~XX, August~2021}% 
{Iasenovets \MakeLowercase{\textit{et al.}}: Bringing Private Reads to Hyperledger Fabric via Private Information Retrieval}
...
\begin{enumerate}
    ...
    chaincode, client logic and benchmarks at the repository: \url{https://github.com/artias13/2_2_HLF_CPIR}.
\end{enumerate}
...
%, as summarized in Table~\ref{tab:feasible_parameters}.

%\begin{table}[!htbp]
%  \centering
%  \caption{Feasible Configurations under $\mathcal{C}$, $\mathcal{M}$, and $\mathcal{D}$.}
%  \label{tab:feasible_parameters}
...
%  512 & 16 & 13 & 8192 & True \\
%  \hline
%  64 & 256 & 14 & 16384 & False \\
%  128 & 128 & 14 & 16384 & False \\
%  224 & 73 & 14 & 16384 & True \\
%  256 & 64 & 14 & 16384 & True \\
%  384 & 42 & 14 & 16384 & True \\
%  512 & 32 & 14 & 16384 & True \\
%  \hline
%  64 & 512 & 15 & 32768 & False \\
%  128 & 256 & 15 & 32768 & False \\
%  224 & 146 & 15 & 32768 & False \\
%  256 & 128 & 15 & 32768 & True \\
%  384 & 85 & 15 & 32768 & True \\
%  512 & 64 & 15 & 32768 & True \\
%  \hline
%  \end{tabular}
%\end{table}
...
Future work should explore constant-time and sublinear execution, sharded CPIR architectures, and
fully encrypted (\emph{ct×ct}) on-chain evaluation to further enhance scalability and privacy.
