...
\begin{enumerate}
    ...
    We present the first end-to-end design and implementation of a native \emph{privacy layer for read operations} in Fabric, 
    realized through a PIR-enabled chaincode that preserves Fabric’s endorsement and audit semantics. 
    This mechanism allows endorsing peers to process encrypted queries without learning which key or record was accessed, 
    introducing the concept of \emph{private reads} as a new privacy primitive for permissioned blockchains. 
    Our integration requires no modifications to Fabric’s consensus or world-state management, demonstrating that private queries 
    can coexist with standard endorsement logic.
    ...
    chaincode, client logic and benchmarks scripts-at: \url{https://github.com/artias13/2_2_HLF_CPIR}.
\end{enumerate}
