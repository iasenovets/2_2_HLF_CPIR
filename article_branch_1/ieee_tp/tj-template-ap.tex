...
\author{Artur Iasenovets\authorrefmark{1},
Fei Tang\authorrefmark{1},
Huihui Zhu\authorrefmark{2},
Ping Wang\authorrefmark{2} and
Lei Liu\authorrefmark{2}}
...
\corresp{Corresponding author: Artur Iasenovets (email: archee.busy@gmail.com).}
...
\begin{abstract}
    ...
    PIR-based \emph{private reads} in Fabric for smaller, sensitive datasets and highlight future directions to optimize performance and scalability.
\end{abstract}
...
Blockchain \cite{nakamoto_bitcoin_2008} is a peer-to-peer network protocols that uses cryptographic primitives and 
...
to endorsing peers during both \emph{evaluate} calls, creating privacy risks in multi-organisation settings.
...
\begin{enumerate}
    \item \textbf{The First Native PIR Integration for Private Reads in Fabric.}
    We present the first end-to-end design, implementation, and evaluation of a HE-based PIR mechanism integrated \emph{directly} into Hyperledger Fabric 
    chaincode. This allows clients to execute \emph{private read} operations from world state via \emph{evaluate} transactions, 
    without leaking \emph{which} key was accessed to any endorsing peer. Our design requires no modifications to Fabric's core, 
    proving the feasibility of a \emph{plug-in} privacy layer for state queries.
    ...
    \item \textbf{Open-Source Release.} To encourage reproducibility, we open-source the complete implementation of our PIR-enabled Fabric 
    chaincode, client applications and benchmarks at the repository: \url{https://github.com/artias13/2_2_HLF_CPIR}.
\end{enumerate}
...
\item \emph{Feasible:} $(\log N=13,s=128,n \leq 64)$; valid pairs include $(128,64)$, $(224,36)$, $(256,32)$, $(384,21)$, $(512,16)$.
\end{itemize}
...
\item \emph{Feasible:} $(\log N=14,s \in {224,256,\dots},n \leq 73)$; valid pairs include $(224,73)$, $(256,64)$, $(384,42)$, $(512,32)$.
\end{itemize}
...
\item \emph{Feasible:} $(\log N=15,s \geq 256,n \leq 128)$; valid pairs include $(256,128)$, $(384,85)$, $(512,64)$.
\end{itemize}
...
for \emph{private reads}, several challenges remain in performance, scalability, and deployment.
...
Future work will explore constant-time and sublinear execution, sharded CPIR architectures, and fully encrypted 
...
\begin{IEEEbiography}[{\includegraphics[width=1in,height=1.25in,clip,keepaspectratio]{figures/authors/arturiasenovets.jpg}}]
{ARTUR IASENOVETS}~is currently pursuing the M.S. degree in the School of Cybersecurity and Information Law at the 
Chongqing University of Posts and Telecommunications. His research interests include blockchain, privacy-enhancing technologies,
and cyber threat intelligence.
\end{IEEEbiography}

\begin{IEEEbiography}[{\includegraphics[width=1in,height=1.25in,clip,keepaspectratio]{figures/authors/feitang.png}}]
{FEI TANG}~received the Ph.D. degree in information security from the Institute of Information Engineering, 
...
\begin{IEEEbiography}[{\includegraphics[width=1in,height=1.25in,clip,keepaspectratio]{figures/authors/huihuizhu.jpg}}]
{HUIHUI ZHU}~is currently working toward a Ph.D. degree in the School of Computer Science and Technology, 
...
\begin{IEEEbiography}[{\includegraphics[width=1in,height=1.25in,clip,keepaspectratio]{figures/authors/pingwang.jpg}}]
{PING WANG}~received her M.S. degree from Chongqing University of Posts and Telecommunications in 2022. She is currently pursuing a Ph.D. 
...
\begin{IEEEbiography}[{\includegraphics[width=1in,height=1.25in,clip,keepaspectratio]{figures/authors/leiliu.jpg}}]
{LEI LIU}~received his M.S. degree in Integrated Circuit Engineering from Fuzhou University in 2018. He is currently pursuing 
